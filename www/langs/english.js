...
var english = {
  ...
  overview: {
    ...
    p5: "Smell MyCity is supported by Seventh Generation, which is committed to <a href='https://www.seventhgeneration.com/action/climate-justice-equity' target='_blank'>Climate Justice & Equity</a> for the next seven generations and beyond. With support from Seventh Generation, the Smell MyCity app will be made available to residents across the country, so that we all have an opportunity to join a larger, nationwide community of citizens actively documenting the human impacts of air pollution.",
  ...
  about: {
    ...
    h2_3: "Our Local Partners",
    p5: "Our Louisville pilot is made possible with support from The Envirome Institute at the University of Louisville, and in partnership with:",
